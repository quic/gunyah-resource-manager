...
#ifndef ARCH_GICV3_VGIC_H_
#define ARCH_GICV3_VGIC_H_
...
static const size_t vgic_gits_size	 = (size_t)2U << 16;
static const size_t vgic_gits_xlate_size = (size_t)1U << 16;
static const size_t vgic_alignment	 = (size_t)1U << 16;

#else

#error include /vgic.h multiple include
