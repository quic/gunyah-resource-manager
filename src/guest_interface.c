...
gunyah_hyp_partition_create_partition(cap_id_t src_partition, cap_id_t cspace)
{
	...
	register uint64_t	_in_x2 __asm__("x2") = 0x0U;
	register uint32_t	_out_x0 __asm__("x0");
	register uint64_t	_out_x1 __asm__("x1");

	__asm__ volatile("hvc 0x6001"
			 : "=r"(_out_x0), "=r"(_out_x1), "+r"(_in_x2)
			 : "r"(_in_x0), "r"(_in_x1)
...
gunyah_hyp_object_activate(cap_id_t cap)
{
	...
	register uint64_t	_in_x1 __asm__("x1") = 0x0U;
	register uint32_t	_out_x0 __asm__("x0");
...
gunyah_hyp_object_activate_from(cap_id_t cspace, cap_id_t cap)
{
	...
	register uint64_t	_in_x1 __asm__("x1") = (uint64_t)(cap);
	register uint64_t	_in_x2 __asm__("x2") = 0x0U;
	register uint32_t	_out_x0 __asm__("x0");

	__asm__ volatile("hvc 0x600d"
			 : "=r"(_out_x0), "+r"(_in_x1), "+r"(_in_x2)
			 : "r"(_in_x0)
			 : "x3", "x4", "x5", "x6", "x7", "x8", "x9", "x10",
			   "x11", "x12", "x13", "x14", "x15", "x16", "x17");
...
gunyah_hyp_doorbell_bind_virq(cap_id_t doorbell, cap_id_t vic, virq_t virq)
{
	...
	register uint64_t	_in_x1 __asm__("x1") = (uint64_t)(vic);
	register uint32_t	_in_x2 __asm__("x2") = (uint32_t)(virq);
	register uint64_t	_in_x3 __asm__("x3") = 0x0U;
	register uint32_t	_out_x0 __asm__("x0");
...
{
	const register uint64_t _in_x0 __asm__("x0") = (uint64_t)(doorbell);
	register uint64_t	_in_x1 __asm__("x1") = (uint64_t)(enable_mask);
	register uint64_t	_in_x2 __asm__("x2") = (uint64_t)(ack_mask);
	register uint64_t	_in_x3 __asm__("x3") = 0x0U;
	register uint32_t	_out_x0 __asm__("x0");
			 ...
			 msgqueue_send_flags_t send_flags)
{
	...
	register uint64_t	_in_x2 __asm__("x2") = (uint64_t)(data);
	register uint32_t _in_x3 __asm__("x3") = (uint32_t)(send_flags.bf[0]);
	register uint64_t _in_x4 __asm__("x4") = 0x0U;
	register uint32_t _out_x0 __asm__("x0");
...
{
	const register uint64_t _in_x0 __asm__("x0") = (uint64_t)(msgqueue);
	register uint32_t _in_x1 __asm__("x1") = (uint32_t)(not_full_thres);
	register uint32_t _in_x2 __asm__("x2") = (uint32_t)(not_full_holdoff);
	register uint64_t _in_x3 __asm__("x3") = 0xffffffffffffffffU;
	register uint32_t _out_x0 __asm__("x0");
...
{
	const register uint64_t _in_x0 __asm__("x0") = (uint64_t)(msgqueue);
	register uint32_t _in_x1 __asm__("x1") = (uint32_t)(not_empty_thres);
	register uint32_t _in_x2 __asm__("x2") = (uint32_t)(not_empty_holdoff);
	register uint64_t _in_x3 __asm__("x3") = 0xffffffffffffffffU;
	register uint32_t _out_x0 __asm__("x0");
...
{
	const register uint64_t _in_x0 __asm__("x0") = (uint64_t)(msgqueue);
	register uint64_t _in_x1 __asm__("x1") = (uint64_t)(create_info.bf[0]);
	register uint64_t _in_x2 __asm__("x2") = 0x0U;
	register uint32_t _out_x0 __asm__("x0");
				...
				cap_id_t dest_cspace, cap_rights_t rights_mask)
{
	...
	register uint64_t	_in_x2 __asm__("x2") = (uint64_t)(dest_cspace);
	register uint32_t	_in_x3 __asm__("x3") = (uint32_t)(rights_mask);
	register uint64_t	_in_x4 __asm__("x4") = 0x0U;
	register uint32_t	_out_x0 __asm__("x0");
	register uint64_t	_out_x1 __asm__("x1");
...
{
	const register uint64_t _in_x0 __asm__("x0") = (uint64_t)(src_cspace);
	register uint64_t	_in_x1 __asm__("x1") = (uint64_t)(src_cap);
	register uint64_t	_in_x2 __asm__("x2") = 0x0U;
	register uint32_t	_out_x0 __asm__("x0");
...
{
	const register uint64_t _in_x0 __asm__("x0") = (uint64_t)(cspace);
	register uint32_t	_in_x1 __asm__("x1") = (uint32_t)(max_caps);
	register uint64_t	_in_x2 __asm__("x2") = 0x0U;
	register uint32_t	_out_x0 __asm__("x0");
			 ...
			 vic_option_flags_t vic_options, count_t max_msis)
{
	...
	register uint32_t	_in_x1 __asm__("x1") = (uint32_t)(max_vcpus);
	register uint32_t	_in_x2 __asm__("x2") = (uint32_t)(max_virqs);
	register uint64_t _in_x3 __asm__("x3") = (uint64_t)(vic_options.bf[0]);
	register uint32_t _in_x4 __asm__("x4") = (uint32_t)(max_msis);
	register uint32_t _out_x0 __asm__("x0");
...
{
	const register uint64_t _in_x0 __asm__("x0") = (uint64_t)(vic);
	register uint64_t	_in_x1 __asm__("x1") = (uint64_t)(vcpu);
	register uint32_t	_in_x2 __asm__("x2") = (uint32_t)(index);
	register uint64_t	_in_x3 __asm__("x3") = 0x0U;
	register uint32_t	_out_x0 __asm__("x0");
...
gunyah_hyp_addrspace_attach_thread(cap_id_t addrspace, cap_id_t thread)
{
	...
	register uint64_t	_in_x1 __asm__("x1") = (uint64_t)(thread);
	register uint64_t	_in_x2 __asm__("x2") = 0x0U;
	register uint32_t	_out_x0 __asm__("x0");
...
{
	const register uint64_t _in_x0 __asm__("x0") = (uint64_t)(addrspace);
	register uint64_t	_in_x1 __asm__("x1") = (uint64_t)(memextent);
	register uint64_t	_in_x2 __asm__("x2") = (uint64_t)(vbase);
	register uint32_t _in_x3 __asm__("x3") = (uint32_t)(map_attrs.bf[0]);
	register uint64_t _in_x4 __asm__("x4") = 0x0U;
	register uint32_t _out_x0 __asm__("x0");
				   ...
				   memextent_access_attrs_t access_attrs)
{
	...
	register uint64_t	_in_x1 __asm__("x1") = (uint64_t)(memextent);
	register uint64_t	_in_x2 __asm__("x2") = (uint64_t)(vbase);
	register uint32_t _in_x3 __asm__("x3") = (uint32_t)(access_attrs.bf[0]);
	register uint64_t _in_x4 __asm__("x4") = 0x0U;
	register uint32_t _out_x0 __asm__("x0");
...
{
	const register uint64_t _in_x0 __asm__("x0") = (uint64_t)(addrspace);
	register uint16_t	_in_x1 __asm__("x1") = (uint16_t)(vmid);
	register uint64_t	_in_x2 __asm__("x2") = 0x0U;
	register uint32_t	_out_x0 __asm__("x0");
...
{
	const register uint64_t _in_x0 __asm__("x0") = (uint64_t)(addrspace);
	register uint64_t	_in_x1 __asm__("x1") = (uint64_t)(dma_device);
	register uint32_t	_in_x2 __asm__("x2") = (uint32_t)(index);
	register uint64_t	_in_x3 __asm__("x3") = 0x0U;
	register uint32_t	_out_x0 __asm__("x0");
...
{
	const register uint64_t _in_x0 __asm__("x0") = (uint64_t)(memextent);
	register uint64_t	_in_x1 __asm__("x1") = (uint64_t)(phys_base);
	register uint64_t	_in_x2 __asm__("x2") = (uint64_t)(size);
	register uint32_t _in_x3 __asm__("x3") = (uint32_t)(attributes.bf[0]);
	register uint64_t _in_x4 __asm__("x4") = 0x0U;
	register uint32_t _out_x0 __asm__("x0");
...
{
	const register uint64_t _in_x0 __asm__("x0") = (uint64_t)(memextent);
	register uint64_t _in_x1 __asm__("x1") = (uint64_t)(parent_memextent);
	register uint64_t _in_x2 __asm__("x2") = (uint64_t)(offset);
	register uint64_t _in_x3 __asm__("x3") = (uint64_t)(size);
	register uint32_t _in_x4 __asm__("x4") = (uint32_t)(attributes.bf[0]);
	register uint64_t _in_x5 __asm__("x5") = 0x0U;
	register uint32_t _out_x0 __asm__("x0");

	__asm__ volatile("hvc 0x6032"
			 : "=r"(_out_x0), "+r"(_in_x1), "+r"(_in_x2),
			   "+r"(_in_x3), "+r"(_in_x4), "+r"(_in_x5)
			 : "r"(_in_x0)
...
gunyah_hyp_vcpu_configure(cap_id_t cap_id, vcpu_option_flags_t vcpu_options)
{
	...
	register uint64_t _in_x1 __asm__("x1") = (uint64_t)(vcpu_options.bf[0]);
	register uint64_t _in_x2 __asm__("x2") = 0x0U;
	register uint32_t _out_x0 __asm__("x0");
...
{
	const register uint64_t _in_x0 __asm__("x0") = (uint64_t)(cap_id);
	register uint64_t	_in_x1 __asm__("x1") = (uint64_t)(entry_point);
	register uint64_t	_in_x2 __asm__("x2") = (uint64_t)(context);
	register uint64_t	_in_x3 __asm__("x3") = 0x0U;
	register uint32_t	_out_x0 __asm__("x0");
...
{
	const register uint32_t _in_x0 __asm__("x0") =
		(uint32_t)(control.bf[0]);
	register uint64_t _in_x1 __asm__("x1") = (uint64_t)(arg1);
	register uint64_t _in_x2 __asm__("x2") = 0x0U;
	register uint32_t _out_x0 __asm__("x0");
...
{
	const register uint64_t _in_x0 __asm__("x0") = (uint64_t)(cap_id);
	register uint16_t	_in_x1 __asm__("x1") = (uint16_t)(affinity);
	register uint64_t	_in_x2 __asm__("x2") = 0xffffffffffffffffU;
	register uint32_t	_out_x0 __asm__("x0");
...
{
	const register uint64_t _in_x0 __asm__("x0") = (uint64_t)(cap_id);
	register uint32_t	_in_x1 __asm__("x1") = (uint32_t)(priority);
	register uint32_t	_out_x0 __asm__("x0");
...
{
	const register uint64_t _in_x0 __asm__("x0") = (uint64_t)(cap_id);
	register uint64_t	_in_x1 __asm__("x1") = (uint64_t)(timeslice);
	register uint32_t	_out_x0 __asm__("x0");
...
{
	const register uint64_t _in_x0 __asm__("x0") = (uint64_t)(vic);
	register uint64_t	_in_x1 __asm__("x1") = (uint64_t)(msi_source);
	register uint64_t	_in_x2 __asm__("x2") = 0x0U;
	register uint32_t	_out_x0 __asm__("x0");
...
{
	const register uint32_t _in_x0 __asm__("x0") = (uint32_t)(num_bytes);
	const register uint64_t _in_x1 __asm__("x1") = 0x0U;
	register uint32_t	_out_x0 __asm__("x0");
	register uint32_t	_out_x1 __asm__("x1");
	register uint32_t	_out_x2 __asm__("x2");
	register uint32_t	_out_x3 __asm__("x3");
	register uint32_t	_out_x4 __asm__("x4");
	...
	return (gunyah_hyp_prng_get_entropy_result_t){
		.error = (error_t)_out_x0,
		.data0 = (uint32_t)_out_x1,
		.data1 = (uint32_t)_out_x2,
		.data2 = (uint32_t)_out_x3,
		.data3 = (uint32_t)_out_x4,
	};
}
...
{
	const register uint64_t _in_x0 __asm__("x0") = (uint64_t)(src_cspace);
	register uint64_t	_in_x1 __asm__("x1") = (uint64_t)(master_cap);
	register uint64_t	_in_x2 __asm__("x2") = 0x0U;
	register uint32_t	_out_x0 __asm__("x0");
